...
import (
	...
	integrations "github.com/weaveworks/flux/integrations/client/informers/externalversions/integrations"
...
func (f *sharedInformerFactory) Integrations() integrations.Interface {
	return integrations.New(f)
}
